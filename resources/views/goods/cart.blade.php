				...
				<ul class="cart-prolist-ul" style="border: 0;">
					<li data-parent-shopid="0">
						<h2 class="title">
							...
							店铺名称：官方直营店 <div class="cart_ed">
								<a id="cart_edit0" data-shopid="0" onclick="cart_edit(this,0)" style="display: block;">编辑</a>
								<a id="edit_success0" onclick="cart_succ(this,0)" style="display: none;">完成</a>
							</div>
						</h2>
					</li>
					<li class="cart-list-li" data-shopid="0">
						<div class="checkbox" is_check="yes" is_del='no'></div>
						<div class="product">
							<div class="pic">
								<a href="http://tp.23673.com/wap/goods/goodsdetail?id=380">
									<img src="static/picture/1500547407504.jpg" alt="商品图片">
								</a>
							</div>
							<div class="info">
								<p class="info-name">
									<a href="http://tp.23673.com/wap/goods/goodsdetail?id=380">印花显瘦A字碎花真丝连衣裙女夏季2017新款欧洲站气质裙子女装潮<span><br /></span></a>
								</p>
							</div>
						</div>
						<div class="number">
							¥<span name="goods_price">359</span>
							×<span name="succ_amount">1</span>
							<div name="edit_num0" style="display: none;">
								<span class="ui-number">
									<button type="button" class="decrease" onclick="Cart.changeBar(&#39;-&#39;,34,this)" title="减">-</button>
									<input class="num" name="quantity" autocomplete="off" data-default-num="1" value="1" min="1" max="999" max_buy="0" data-cartid="34" data-shopid="0">
