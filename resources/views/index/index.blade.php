...
<head>
    ...
    <script type="text/javascript">
        ...
        var ADMINMAIN = 'http://lms.test/admin';
...
<!-- 遮罩层 -->
<div class="shade"
     style="position:fixed;top:0px;left:0px;width:100%;height:100%;margin-top:0;background: rgba(0, 0, 0, 0.7);z-index: 999;display:none;"><span
        style="float: right; padding: 15px;font-size: 22px;color: #fff;background: transparent;"
        id="close">X</span></div>
<!-- 弹出层 -->
...
<div class="com-content">
            ...
            <div class="control-group">
                <div class="custom-search">
                    <input type="text" class="custom-search-input" placeholder="搜索商品"
                           style="background:#f4f4f4;border:none;border-radius:0;padding-right:10%;">
    ...
    <div class="slick">
        <div style="display:block;text-align:center;width:100%;height:175px;line-height:175px;">
            <a href="#">
                <img src="static/picture/1497070640.png" alt=""
                     style="height:175px;max-width:100%;display: inline-block !important;vertical-align: middle !important;">
            </a>
        </div>
    </div>
    <script>
